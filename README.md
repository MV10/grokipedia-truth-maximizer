...
* Right-click the icon to toggle automatic navigation.
* Probably only works with the English-language sites.
* Requires a Grokipedia account (likely your X.com account).

This does not store, require, or use any personal data or similar sensitive information.
...
A future release may allow you to submit a Grokipedia content-request if there is no match for the Wikipedia article you're viewing.
